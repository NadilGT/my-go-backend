...
func DB_FindProductsByCategory(categoryId string) ([]dto.Product, error) {
...
func DB_FindProductsByCategoryCursorPaginated(categoryId string, limit int, cursor string) ([]dto.Product, string, bool, error) {
	collection := dbConfigs.DATABASE.Collection("Products")
	ctx := context.Background()
